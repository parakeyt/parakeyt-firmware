	...
	{                                                                                   \
		{                                                                           \
			{ HID_KEY_A, HID_KEY_S, HID_KEY_D,	    HID_KEY_F,              \
			  HID_KEY_8, HID_KEY_9, HID_KEY_APOSTROPHE, HID_KEY_J },            \
				{ HID_KEY_K, HID_KEY_L, HID_KEY_SEMICOLON, HID_KEY_1,       \
				  HID_KEY_2, HID_KEY_3, HID_KEY_4,	   HID_KEY_SPACE }, \
			{                                                                   \
				HID_KEY_C, HID_KEY_Z, HID_KEY_NONE                          \
			}                                                                   \
		}                                                                           \
	}
